...
// Given an array Arr[] of size N and an integer K, you have to choose the first
// two minimum elements of the array and erase them, then insert the sum of
// these two elements in the array until all the elements are greater than or
// equal to K and find the number of such operations required.
...
// function minOperations() which takes array of integers arr, n and k as
